...
int main() {
  ...
  auto mat_sphere = make_shared<lambertian>(vec3(0.7, 0.3, 0.3));
  auto mat_left = make_shared<metal>(vec3(0.8, 0.8, 0.8));
  auto mat_right = make_shared<metal>(vec3(0.8, 0.6, 0.2));
